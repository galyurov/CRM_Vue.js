                ...
                <div class="result-wrap">
                  ...
                  <template v-else>
                      ...
                      <div class="result-block">
                        <div class="result-about">
                          <table class="result-table">
                            ...
                            <tr class="result-tr">
                              <td>Move Type:</td>
                              <td v-if="(+data.entryParams.rangeInfo > (+price['local-max-distance']+ +price['freeMile']))" class="move-type">
                                {{ data.entryParams.typeOfMoveInfo + ',' }}{{`Long Distance Moving`}}
                              </td>
                              <td v-if="(+data.entryParams.rangeInfo < (+price['local-max-distance']+ +price['freeMile']))" class="move-type">
                                {{ data.entryParams.typeOfMoveInfo + ',' }}{{`Local Moving`}}
                              </td>
                            </tr>
                            <tr class="result-tr">
                              <td>Distance:</td>
                        ...
                        <div class="result-about b0">
                          <table class="result-table table--for--render">
                            ...
                            <tr
                                v-if="data.entryParams.infoPriceInfo"
                                class="result-tr"
                            >
                              <td class="result-total-moving sum-price">
                            ...
                            <tr
                                v-if="data.entryParams.infoPrice2Info"
                                class="result-tr"
                            >
                              <td class="result-total-moving sum-price">
                            ...
                            <tr
                                v-if="data.entryParams.infoPrice3Info"
                                class="result-tr"
                            >
                              <td class="result-total-moving sum-price">
                            ...
                            <tr
                                v-if="data.entryParams.liablePriceInfo"
                                class="result-tr"
                            >
                              <td
                            ...
                            <tr
                                v-if="data.entryParams.discountPriceInfo"
                                class="result-tr"
                            >
                              <td
                                  class="result-total-total"
                    ...
                    <div  class="result-estimate">
                      ...
                      <div v-if="data.entryParams.rangeInfo > 110 && (data.entryParams.binding == 'Non-Binding' || data.entryParams.binding == 'None')" class="estimate-block result-block request px-2">
                        <p>
                      ...
                      <div v-if="data.entryParams.rangeInfo > 110 && data.entryParams.binding == 'Binding'" class="estimate-block result-block request px-2">
                        <p>
                      ...
                      <div v-if="data.entryParams.rangeInfo < 110 &&  data.entryParams.binding == 'None'" class="estimate-block result-block request px-2">
                        <h5>
                          THE PRICE ABOVE IS AN HOURLY RATE ONLY, 3 HOURS
                          MINIMUM CHARGE, ANY ADDITIONAL HOUR WILL BE CHARGED
                          PER THE RATE ABOVE.
                      ...
                      <div v-if="data.entryParams.rangeInfo < 110 && data.entryParams.binding == 'Non-Binding'" class="estimate-block result-block request px-2">
                        <p>
                          Thank you!
                        </p>
                      </div>
                    ...
                    >
                      ...
                      <div class="result-about b0">
                        <table class="result-inventory result-inventory-entry">
                          ...
                          <template v-if="data.entryParams.specialInventory">
                            <tr>
                              <td class="title__handling" colspan="6">
                                Special Handling
                              </td>
